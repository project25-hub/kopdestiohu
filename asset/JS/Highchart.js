...
function keuangan_mingguan(value, selector, bulan,  tahun){
   var title = {
      text: 'Keuangan minggu-an BUMDes Huyula  bulan '+bulan+' '+tahun
   };
   var subtitle = {
      text: 'Sumber: BUMDes Huyula '
   };
...
function keuangan_bulanan(value, selector, tahun){
   var title = {
      text: 'Keuangan bulan-an BUMDes Huyula  Tahun '+tahun
   };
   var subtitle = {
      text: 'Sumber: BUMDes Huyula '
   };
...
function keuangan_tahunan(value, selector){
   var title = {
      text: 'Keuangan tahun-an BUMDes Huyula '   
   };
   var subtitle = {
      text: 'Sumber: BUMDes Huyula '
   };
...
function pertumbuhan_laba(value, selector, $tahun=null){
   var title = {
      text: 'Pertumbuhan laba usaha BUMDes Huyula  tahun 2025'   
   };
   var subtitle = {
      text: 'Sumber: BUMDes Huyula '
   };
