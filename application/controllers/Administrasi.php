...
class Administrasi extends CI_Controller{
    ...
    function security(){//=============ada view
        ...
        $kat = ['MNG'=>'Pengurus BUMDes Huyula','GOV'=>'Pemerintah Desa Tiohu','SYS'=>'Sistem Admin Web BUMDes'];
        if (!$ajax) {
    ...
    function detail_user($id){
        $kat =['MNG'=>'Pengurus BUMDes', 'GOV'=>'Pemerintahan Desa Tiohu'];
    ...
    function set_admin_baru(){
        ...
        if ($v['res']) {
            ...
            $subject = 'Registrasi admin baru sistem manajemen BUMDes Huyula '.date('d-m-Y');
    ...
    function pdf_daftar_aset(){
        ...
        $this->PDF->SetFont('Arial','B',12);
        $this->PDF->Cell(180,8,'BUMDES Huyula',0,1,'C');
    ...
    function edit_profil(){
        ...
        if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($v1['res']) {
                ...
                $subject = 'Konfirmasi perubahan email admin sistem manajemen BUMDes Huyula '.date('d-m-Y');
