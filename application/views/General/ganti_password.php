...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo base_url(); ?>favicon_tiohu.ico" type="image/gif">
    <title><?= $title?></title>
    ...
    <div class="container body">
      <div class="login_content">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <h1><img src="<?php echo base_url(); ?>logobumdeshuyula_trans.png"style="max-width:100px;max-height:100px;"> BUMDes Huyula</h1>
        </div>
      </div>
